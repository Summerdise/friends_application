...
public class Comment implements Parcelable {
    ...
    public static final Creator<Comment> CREATOR = new Creator<Comment>() {
        @Override
        public com.example.friendsservice.Comment createFromParcel(Parcel in) {
            return new com.example.friendsservice.Comment(in);
        }

        @Override
        public com.example.friendsservice.Comment[] newArray(int size) {
            return new com.example.friendsservice.Comment[size];
        }
    };
